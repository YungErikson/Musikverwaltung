...
/**
 * Diese Klasse repräsentiert das Untermenü zum Anzeigen und Abspielen von Songs nach Genre sortiert.
 * Benutzer können die Songs nach Genre anzeigen und einzelne Songs abspielen.
 */
public class SongsNachGenreUntermenue extends JFrame {
    private List<Song> songs;

    /**
     * Konstruktor zur Initialisierung des SongsNachGenreUntermenue-Objekts.
     *
     ...
     */
    public SongsNachGenreUntermenue(JFrame previousFrame, List<Song> songs) {
        this.songs = songs;
